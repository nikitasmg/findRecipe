import { CARDS_ONE_BUTTON_NAME, CARDS_ONE_BUTTON_NAME_EN, CARDS_ONE_DESCRIPTION, CARDS_ONE_DESCRIPTION_EN, CARDS_ONE_IMAGE, CARDS_ONE_ROUTE, CARDS_ONE_TITLE, CARDS_ONE_TITLE_EN, CARDS_TWO_BUTTON_NAME, CARDS_TWO_BUTTON_NAME_EN, CARDS_TWO_DESCRIPTION, CARDS_TWO_DESCRIPTION_EN, CARDS_TWO_IMAGE, CARDS_TWO_ROUTE, CARDS_TWO_TITLE, CARDS_TWO_TITLE_EN } from "./constants";
...
export type InfoBlockCardsFields = {
    ...
    "params.cards_1.button_name"?: string;
    "params.cards_1.button_name_en"?: string;
    ...
    "params.cards_2.button_name"?: string;
    "params.cards_2.button_name_en"?: string;
  ...
  export type NamesInfoBlock = {
    ...
    cardOneButtonName: typeof CARDS_ONE_BUTTON_NAME | typeof CARDS_ONE_BUTTON_NAME_EN;
    ...
    cardTwoButtonName: typeof CARDS_TWO_BUTTON_NAME | typeof CARDS_TWO_BUTTON_NAME_EN;
